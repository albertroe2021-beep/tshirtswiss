...
def link(path, base=''):
    """Return a link relative to the site root/base.

    Pass base='/' or base='/tshirtswiss/' for absolute deployment paths,
    or leave empty for relative generation from a root-aware workflow.
    """
    return f"{base}{path}"
